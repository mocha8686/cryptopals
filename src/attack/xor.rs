...
///
/// ```
/// use cryptopals::{Data, attack::xor::partition};
///
/// let data = Data::from("qwertyuiopasdfghjklzxcvbnm".as_bytes());
/// let keysize = 4;
/// let partitions = partition(&data, keysize);
///
/// assert_eq!(keysize as usize, partitions.len());
/// assert_eq!(Data::from("qtodjxn".as_bytes()), partitions[0]);
/// assert_eq!(Data::from("wypfkcm".as_bytes()), partitions[1]);
/// assert_eq!(Data::from("euaglv".as_bytes()), partitions[2]);
/// assert_eq!(Data::from("rishzb".as_bytes()), partitions[3]);
/// ```
...
///
/// ```
/// use cryptopals::{Data, attack::xor::unpartition};
///
/// let partitions = vec![
///     Data::from("qtodjxn".as_bytes()),
///     Data::from("wypfkcm".as_bytes()),
///     Data::from("euaglv".as_bytes()),
///     Data::from("rishzb".as_bytes()),
/// ];
///
/// let res = unpartition(partitions);
///
/// assert_eq!(Data::from("qwertyuiopasdfghjklzxcvbnm".as_bytes()), res);
/// ```
#[must_use]
