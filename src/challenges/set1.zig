...
test "challenge 1" {
    ...
    try std.testing.expectEqualStrings(base64, test_base64.buf);
    ...
    try std.testing.expectEqualStrings(hex, test_hex.buf);
}
...
test "challenge 2" {
    ...
    try std.testing.expectEqualStrings("746865206b696420646f6e277420706c6179", res.buf);
}
...
test "[slow] challenge 6" {
    ...
    try std.testing.expectEqualStrings(@embedFile("data/1/6-sol.txt"), plaintext.buf);
}
